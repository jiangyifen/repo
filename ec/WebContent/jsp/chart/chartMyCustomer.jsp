...
function validate() {
    ...
    document.getChartMyCustomer.src="getChartMyCustomer.action?beginTime="+beginTime+"&endTime="+endTime+"&orderByWorkload="+orderByWorkload+"&groupByName=true";
}
</script>

</head>
<body>
<form name="form1" action="getChartMyCustomer.action">
...
<img name="getChartMyCustomer" src="getChartMyCustomer.action?beginTime=${sessionScope.today}&endTime=${sessionScope.today}&groupByName=true"/>
</body>
</html>
