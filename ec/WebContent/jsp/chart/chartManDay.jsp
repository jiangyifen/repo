...
function validate() {
    ...
    document.chart1.src="getChartManDay.action?beginTime="+beginTime+"&endTime="+endTime;
...
<body>
<form name="form1" action="getChartManDay.action">

    <div id="sxStatHdr" class="sctHdr">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="100%">人天数统计</td>
            </tr>
        </table>
    </div>
...
<img name="chart1" src="getChartManDay.action?beginTime=${sessionScope.oneMonthAgo}&endTime=${sessionScope.today}"/>
