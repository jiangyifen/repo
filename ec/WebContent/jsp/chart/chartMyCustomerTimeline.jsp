...
function validate() {
    ...
    document.chart1.src="getChartMyCustomerTimeline.action?beginTime="+beginTime+"&endTime="+endTime;
}
</script>

</head>
<body>
<form name="form1" action="getChartMyCustomerTimeline.action">

    <div id="sxStatHdr" class="sctHdr">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="100%">意向客户时间线</td>
            </tr>
        </table>
    </div>
...
<img name="chart1" src="getChartMyCustomerTimeline.action?beginTime=${sessionScope.oneMonthAgo}&endTime=${sessionScope.today}"/>
