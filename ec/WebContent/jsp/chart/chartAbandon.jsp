...
function validate() {
    ...
    document.chart1.src="getChartAbandon.action?beginTime="+beginTime+"&endTime="+endTime;
}
</script>

</head>
<body>
<form name="form1" action="getChartAbandon.action">

    <div id="sxStatHdr" class="sctHdr">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="100%">放弃次数</td>
            </tr>
        </table>
    </div>
...
<img name="chart1" src="getChartAbandon.action?beginTime=${sessionScope.oneMonthAgo}&endTime=${sessionScope.today}"/>
