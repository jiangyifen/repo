...
<body>
<form name="form1" action="getChartAgentAssessment.action">

    <div id="sxStatHdr" class="sctHdr">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="100%">座席人员考核数据</td>
            </tr>
        </table>
    </div>
    ...
    <div class="cfg">
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr class="cat">
                <td colspan="2"><div>求日平均值:<input name="average"  type="checkbox" checked/></div></td>
            </tr>
            <tr class="cat">
