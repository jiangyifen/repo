...
function validate() {
    ...
    if (!document.form1.endTime.value) {
        ...
        document.chartWeightedWorkload.src="getChartWeightedWorkload.action?beginTime="+beginTime+"&endTime="+endTime;
}
</script>
...
<form name="form1" action="getChartWeightedWorkload.action">

    <div id="sxStatHdr" class="sctHdr">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="100%">加权工作量统计</td>
            </tr>
        </table>
    </div>
...
<img name="chartWeightedWorkload" src="getChartWeightedWorkload.action?beginTime=${sessionScope.today}&endTime=${sessionScope.today}"/>
</body>
</html>