...
function validate() {
    ...
    document.chartQueueIncomingWorkloadTimes.src="getChartQueueIncomingWorkload.action?beginTime="+beginTime+"&endTime="+endTime+"&groupByName="+groupByName+"&groupByTeam="+groupByTeam+"&average="+average+"&orderByWorkload="+orderByWorkload;
    document.chartQueueIncomingWorkloadTimelen.src="getChartQueueIncomingWorkload.action?beginTime="+beginTime+"&endTime="+endTime+"&groupByName="+groupByName+"&groupByTeam="+groupByTeam+"&average="+average+"&orderByWorkload="+orderByWorkload + "&timelen";
}
</script>

</head>
<body>
<form name="form1" action="getChartQueueIncomingWorkload.action">

    <div id="sxStatHdr" class="sctHdr">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="100%">呼入话务量统计</td>
            </tr>
        </table>
    </div>
...
<img name="chartQueueIncomingWorkloadTimes" src="getChartQueueIncomingWorkload.action?beginTime=${sessionScope.today}&endTime=${sessionScope.today}"/>
<img name="chartQueueIncomingWorkloadTimelen" src="getChartQueueIncomingWorkload.action?beginTime=${sessionScope.today}&endTime=${sessionScope.today}&timelen"/>
