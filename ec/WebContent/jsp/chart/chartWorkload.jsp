...
function validate() {
    ...
    document.chartWorkloadTimes.src="getChartWorkload.action?beginTime="+beginTime+"&endTime="+endTime+"&groupByTeam="+groupByTeam+"&orderByWorkload="+orderByWorkload;
    
    //document.chartWorkloadEfficiency.src="getChartWorkload.action?beginTime="+beginTime+"&endTime="+endTime+"&groupByTeam="+groupByTeam+"&orderByWorkload="+orderByWorkload + "&efficiency";
}
</script>
...
<form name="form1" action="getChartWorkload.action">
...
<img name="chartWorkloadTimes" src="getChartWorkload.action?beginTime=${sessionScope.today}&endTime=${sessionScope.today}"/>
<!-- <img name="chartWorkloadEfficiency" src="getChartWorkload.action?beginTime=${sessionScope.today}&endTime=${sessionScope.today}&efficiency"/> -->
</body>
</html>
