...
function validate() {
    ...
    document.chartSMSendQuantity.src="getChartSMSendQuantity.action?beginTime="+beginTime+"&endTime="+endTime+"&groupByTeam="+groupByTeam+"&orderByWorkload="+orderByWorkload;
}
</script>
...
<img name="chartSMSendQuantity" src="getChartSMSendQuantity.action?beginTime=${sessionScope.oneMonthAgo}&endTime=${sessionScope.today}"/>
