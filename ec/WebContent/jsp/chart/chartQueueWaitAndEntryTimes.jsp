...
function validate() {
    ...
    document.chart1.src="getChartQueueWaitAndEntryTimes.action?beginTime="+beginTime+"&endTime="+endTime;
}
</script>

</head>
<body>
<form name="form1" action="getChartQueueWaitAndEntryTimes.action">

    <div id="sxStatHdr" class="sctHdr">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="100%">平均等待时间</td>
            </tr>
        </table>
    </div>
...
<img name="chart1" src="getChartQueueWaitAndEntryTimes.action?beginTime=${sessionScope.oneMonthAgo}&endTime=${sessionScope.today}"/>
