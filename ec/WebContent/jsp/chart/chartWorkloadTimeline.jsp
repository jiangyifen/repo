...
function validate() {
	...
	var timelen = document.form1.timelen.checked;
    var excel = document.form1.excel.checked;
    if(excel){
        document.form1.submit();
    }
    document.chart1.src="getChartWorkloadTimeline.action?beginTime="+beginTime+"&endTime="+endTime+"&timelen="+timelen;
}
</script>

</head>
<body>
<form name="form1" action="getChartWorkloadTimeline.action">

    <div id="sxStatHdr" class="sctHdr">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="100%">工作量时间线</td>
            </tr>
        </table>
    </div>
    ...
    <div class="cfg">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr class="cat">
                <td colspan="2"><div>开始日期:&nbsp;&nbsp;&nbsp;&nbsp;<input name="beginTime"  type="text" onclick="WdatePicker({skin:'blue'})" class="text" value="${sessionScope.oneMonthAgo}"/>&nbsp;&nbsp;00:00:00</div></td>
            </tr>
            ...
            <tr class="cat">
                <td colspan="2"><div>统计呼叫时长:<input name="timelen"  type="checkbox"/></div></td>
            </tr>
            <tr class="cat">
...
<img name="chart1" src="getChartWorkloadTimeline.action?beginTime=${sessionScope.oneMonthAgo}&endTime=${sessionScope.today}"/>
