...
function validate() {
    ...
    document.chart1.src="getChartWorkloadAverageTimeline.action?beginTime="+beginTime+"&endTime="+endTime;
}
</script>

</head>
<body>
<form name="form1" action="getChartWorkloadAverageTimeline.action">

    <div id="sxStatHdr" class="sctHdr">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="100%">人均工作量时间线</td>
            </tr>
        </table>
    </div>
...
<img name="chart1" src="getChartWorkloadAverageTimeline.action?beginTime=${sessionScope.oneMonthAgo}&endTime=${sessionScope.today}"/>
