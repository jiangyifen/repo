...
function validate() {
    ...
    document.chartTimes.src="getChartQueueWaitDistribution.action?beginTime="+beginTime+"&endTime="+endTime;
...
<body>
<form method="POST" action="getChartQueueWaitDistribution.action"  name="chartform">
...
<img name="chartTimes" src="getChartQueueWaitDistribution.action?beginTime=${sessionScope.today}&endTime=${sessionScope.today}"/>
