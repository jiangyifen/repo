...
function validate() {
    ...
    document.chart1.src="getChartWait.action?beginTime="+beginTime+"&endTime="+endTime;
}
</script>

</head>
<body>
<form name="form1" action="getChartWait.action">
...
<img name="chart1" src="getChartWait.action?beginTime=${sessionScope.oneMonthAgo}&endTime=${sessionScope.today}"/>
