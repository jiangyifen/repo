...
function validate() {
    ...
    document.chartIncomingWorkloadTimes.src="getChartIncomingWorkload.action?beginTime="+beginTime+"&endTime="+endTime+"&groupByTeam="+groupByTeam+"&average="+average+"&orderByWorkload="+orderByWorkload;
    document.chartIncomingWorkloadTimelen.src="getChartIncomingWorkload.action?beginTime="+beginTime+"&endTime="+endTime+"&groupByTeam="+groupByTeam+"&average="+average+"&orderByWorkload="+orderByWorkload + "&timelen";
}
</script>

</head>
<body>
<form name="form1" action="getChartIncomingWorkload.action">
...
<img name="chartIncomingWorkloadTimes" src="getChartIncomingWorkload.action?beginTime=${sessionScope.today}&endTime=${sessionScope.today}"/>
<img name="chartIncomingWorkloadTimelen" src="getChartIncomingWorkload.action?beginTime=${sessionScope.today}&endTime=${sessionScope.today}&timelen"/>
