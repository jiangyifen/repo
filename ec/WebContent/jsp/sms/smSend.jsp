...
<form action="smSend" method="post" name="smSend">

<table>
	<tr>
		<td>
		<fieldset>
			<legend>发送给（多个号码请用“;”分开）：<input type="text" name="phoneNumbers"></legend>
			<legend>请输入内容：</legend> 
			<textarea id="smcontent" name="smcontent" rows="10" cols="70"
			...
			<p>
			最多字数： <input disabled maxLength="4" name="total" size="3" value="700" class="inputtext"> 
			已用字数： <input disabled maxLength="4" name="used" size="3" value="0" class="inputtext">
			剩余字数： <input disabled maxLength="4" name="remain" size="3" value="700" class="inputtext"></p>
		</fieldset>
		</td>
	</tr>
	<tr>
		<td><input type="hidden" name="dialTaskId"
			value="<%=request.getParameter("dialTaskId")%>" /> 日期：<input
			name="date" type="text" onclick="WdatePicker({skin:'blue'})"
			class="text" value="${sessionScope.today}" /> <select name="hour">
			...
			<option value="58">58</option>
			<option value="59">59</option>
		</select> 秒 <input type="reset" value="重写" /> <input type="button" value="发送" onclick="send();"/>
		</td>
	</tr>
</table>
</form>
