...
function initPage() {
  ...
  if (parent.ctx == "vmAddDeviceWizard") {
    ...
    dev = {hi:"device",rdsc:true,rdcs:false,id:"floppy",loc:"/dev/fd0"};
  ...
  obsrvrStr = "vmFloppy_" + parent.ctx + "_" + vm.hash() + ":" + dev.id;
  ...
  lstnr = function (t, o, v) {
    if (v.id == dev.id && confirm("The floppy drive configuration " +
