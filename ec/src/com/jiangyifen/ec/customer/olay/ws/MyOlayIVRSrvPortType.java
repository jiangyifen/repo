...
public interface MyOlayIVRSrvPortType {
    ...
    @WebResult(name = "out", targetNamespace = "http://IVR.myolay.www.accentiv.cn")
    @RequestWrapper(localName = "setmemberinfo", targetNamespace = "http://IVR.myolay.www.accentiv.cn", className = "com.jiangyifen.ec.customer.olay.ws.Setmemberinfo")
    @WebMethod
    @ResponseWrapper(localName = "setmemberinfoResponse", targetNamespace = "http://IVR.myolay.www.accentiv.cn", className = "com.jiangyifen.ec.customer.olay.ws.SetmemberinfoResponse")
    public com.jiangyifen.ec.customer.olay.ws.WebReturnObject setmemberinfo(
        @WebParam(name = "memberInfo", targetNamespace = "http://IVR.myolay.www.accentiv.cn")
        com.jiangyifen.ec.customer.olay.ws.MemberInfo memberInfo
    ) throws RemoteException;

    @WebResult(name = "out", targetNamespace = "http://IVR.myolay.www.accentiv.cn")
    @RequestWrapper(localName = "getmemberinfo", targetNamespace = "http://IVR.myolay.www.accentiv.cn", className = "com.jiangyifen.ec.customer.olay.ws.Getmemberinfo")
    @WebMethod
    @ResponseWrapper(localName = "getmemberinfoResponse", targetNamespace = "http://IVR.myolay.www.accentiv.cn", className = "com.jiangyifen.ec.customer.olay.ws.GetmemberinfoResponse")
    public com.jiangyifen.ec.customer.olay.ws.MemberInfoReturnObject getmemberinfo(
        @WebParam(name = "accountNumber", targetNamespace = "http://IVR.myolay.www.accentiv.cn")
