...
public class QueueAddAction extends BaseAction {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7603184164787222744L;
	...
	public String execute() throws Exception {
		...
		if (queueManager.addQueue(q)) {
			logger.info("Queue " + queuename + " added.");
			return SUCCESS;
		}
		logger.error("Queue name duplicate");
		return INPUT;
	}
