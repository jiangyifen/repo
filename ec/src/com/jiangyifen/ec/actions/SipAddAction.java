...
public class SipAddAction extends BaseAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1955749903411757072L;
	private Long id;
	private String name;
	...
	public String execute() throws Exception {
		...
		if (sipManager.addSip(sip)) {
			return SUCCESS;
		} else {
			logger.error("Sip add failed.");
			return INPUT;
		}
	}
